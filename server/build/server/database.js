...
if (!process.env.DB || typeof process.env.DB === "undefined") {
    throw new Error("No process.env.DB");
}
var Database = /** @class */ (function () {
    function Database() {
        var _this = this;
        var dbStart = function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log("dbStart error " + error_1);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        }); };
        if (typeof process.env.DB === "string" && process.env.DB) {
            dbStart();
        }
        else {
            throw new Error("No process.env.DB");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, mongoose_1.default.createConnection(process.env.DB)];
                    case 1:
                        db = _a.sent();
                    ...
                    case 2:
                        error_2 = _a.sent();
                        console.log("createConnection error " + error_2);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
